...
SMTP_FROM = os.environ.get("SMTP_FROM", "Sara <noreply@sara.example.com>")
...
def send_password_reset_email(recipient: str, token: str) -> bool:
    ...
    subject = "Sara - Reset your password"
    text = (
        "Hi,\n\n"
...
def passkey_register_options(
    ...
    return {
        "publicKey": {
            "rp": {"name": "Sara E-Commerce Store", "id": request.url.hostname or "localhost"},
            "user": {
                "id": user_handle,
                "name": user.email,
