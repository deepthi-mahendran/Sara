...
document.addEventListener('DOMContentLoaded', () => {
  ...
  container.innerHTML = `
        <div style="background: rgba(8,129,120,0.04); border: 1px solid rgba(8,129,120,0.2); border-radius: 8px; padding: 20px; margin: 30px 0; font-family: sans-serif;">
            <h3 style="color:#C483E6; margin-top:0;"><i class="ri-truck-line"></i> Shipping Cost Estimator</h3>
            ...
            <button id="calc-shipping-btn" style="background:#C483E6; color:white; font-weight:600; border:none; padding:10px 18px; border-radius:4px; cursor:pointer;">Calculate Shipping</button>
            <p id="calc-feedback" style="margin:12px 0 0 0; font-weight:700; color:#C483E6; min-height:18px;"></p>
        </div>
    `;
