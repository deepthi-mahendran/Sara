  ...
  const TESTIMONIALS = [
    {
      ...
      rating: 5,
      review:
        'Sara has completely redefined my wardrobe. The fabrics are premium, delivery is always on time, and the customer support is exceptional!',
    ...
    },
    {
      ...
      rating: 5,
      review:
        "The smart ordering system is incredibly fast, and their seasonal deals are unbeatable. I've recommended Sara to all my friends!",
    ...
    },
    {
      ...
      rating: 5,
      review:
        'Absolutely love the fits and designs from Sara. The return process is completely hassle-free, making it the perfect platform for trendsetters.',
