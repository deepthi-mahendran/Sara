...
function initInterests() {
  ...
  interestContainer.innerHTML = `
        ...
        <div style="display:flex; gap:8px; flex-wrap:wrap;">
            <span class="interest-chip" data-val="mens" style="padding:6px 12px; border:1px solid #C483E6; border-radius:15px; font-size:12px; font-weight:600; cursor:pointer; color:#C483E6; transition:all 0.2s;">Men's Apparel</span>
            <span class="interest-chip" data-val="womens" style="padding:6px 12px; border:1px solid #C483E6; border-radius:15px; font-size:12px; font-weight:600; cursor:pointer; color:#C483E6; transition:all 0.2s;">Women's Apparel</span>
            <span class="interest-chip" data-val="acc" style="padding:6px 12px; border:1px solid #C483E6; border-radius:15px; font-size:12px; font-weight:600; cursor:pointer; color:#C483E6; transition:all 0.2s;">Accessories</span>
        </div>
  ...
  document.querySelectorAll('.interest-chip').forEach((chip) => {
    chip.addEventListener('click', () => {
      ...
      if (selectedList.includes(val)) {
        ...
        chip.style.color = '#C483E6';
      } else {
        selectedList.push(val);
        chip.style.background = '#C483E6';
