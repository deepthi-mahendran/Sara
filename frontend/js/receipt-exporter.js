    ...
    return `
      ...
      <head>
        ...
        <style>
          ...
          .header { border-bottom: 2px solid #C483E6; padding-bottom: 15px; margin-bottom: 20px; display: flex; justify-content: space-between; }
          ...
          th { text-align: left; background: #C483E6; color: white; padding: 8px; }
        </style>
      </head>
      <body>
        <div class="header">
          <div>
            <h2>🛍️ Sara E-Commerce Store</h2>
