...
function initTermsPrint() {
  ...
  btn.style.cssText =
    'padding:10px 18px; background:#C483E6; color:white; border:none; border-radius:4px; font-weight:600; cursor:pointer; margin-bottom:20px; font-family:sans-serif;';
