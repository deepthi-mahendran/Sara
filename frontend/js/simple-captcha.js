...
function installCaptcha() {
  ...
  captchaWrapper.innerHTML = `
        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:5px;">
            ...
            <button type="button" id="captcha-reset-btn" aria-label="Refresh Captcha" style="background:none; border:none; color:#C483E6; cursor:pointer; font-size:16px; padding:0 5px;"><i class="ri-refresh-line"></i></button>
        </div>
