...
document.addEventListener('DOMContentLoaded', () => {
  ...
  progressBar.style.cssText =
    'position:fixed; top:0; left:0; height:4px; background:#C483E6; width:0%; z-index:99999; transition:width 0.1s ease;';
  ...
  posts.forEach((post) => {
    ...
    if (details) {
      ...
      timeTag.style.cssText =
        'font-size:11px; font-weight:700; color:#C483E6; display:block; margin-top:6px; text-transform:uppercase;';
