...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  alertBar.style.cssText =
    'background: #C483E6; color: white; padding: 12px; text-align: center; font-weight: 700; font-family: sans-serif; font-size: 14px; margin-bottom: 20px; border-radius: 6px; box-shadow: 0 4px 15px rgba(8,129,120,0.3);';
