...
function initShopSortFilter() {
  ...
  controlPanel.innerHTML = `
        <div>
            <label style="font-size:14px; font-weight:600; margin-right:8px; color: #C483E6;">Filter by Price:</label>
        ...
        <div>
            <label style="font-size:14px; font-weight:600; margin-right:8px; color: #C483E6;">Sort Catalogue:</label>
