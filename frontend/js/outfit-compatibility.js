 ...
 * Resolves: https://github.com/deepthi-mahendran/sara/issues/2112
 */
...
function initCompatibilityChecker() {
  ...
  form.addEventListener('submit', (e) => {
    ...
    if (typeof window !== 'undefined') {
      window.dispatchEvent(new CustomEvent('sara:outfit-checked', { detail: { topColor, bottomColor, result } }));
    }
  });
