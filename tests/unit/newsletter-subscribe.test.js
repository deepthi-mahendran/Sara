...
import { isValidNewsletterEmail } from '../../frontend/js/newsletter-subscribe.js';
import { validateEmailDomain } from '../../frontend/js/newsletter-subscribe.js';
import { isValidNewsletterEmail } from '../../frontend/js/newsletter-subscribe.js';
...
import '../../frontend/js/newsletter-subscribe.js';
...
describe('newsletter-subscribe Unit Tests', () => {
  ...
  it('binds form handlers immediately when the DOM is already ready', async () => {
    ...
    await import('../../frontend/js/newsletter-subscribe.js');
