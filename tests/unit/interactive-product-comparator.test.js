...
import { canAddMoreComparatorItems } from '../../frontend/js/interactive-product-comparator.js';
const InteractiveProductComparator = require('../../frontend/js/interactive-product-comparator.js');
